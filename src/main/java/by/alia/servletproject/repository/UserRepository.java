...
import by.alia.servletproject.builder.UserBuilder;
...
public class UserRepository extends AbstractRepository <User> {
    ...
    @Override public Optional<User> queryForSingleResult(String sqlString, Parameter parameter) throws RepositoryException {
